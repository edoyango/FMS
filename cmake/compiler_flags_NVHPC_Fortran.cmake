...
# NVHPC Fortan
set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -O2 -Mnovect  -gpu=mem:separate -Mnofma -stdpar=gpu -mp=gpu -acc=gpu -gpu=mem:separate")
...
set(CMAKE_Fortran_LINK_FLAGS "-mp=gpu  -acc=gpu" )
